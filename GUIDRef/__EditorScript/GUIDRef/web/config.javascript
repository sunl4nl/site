...
RefTypeNames[RefType.MResource] = "RawResources";
...
RefTypeNavConfig	 = [
	...
	{navType: NavType.RefType 		, name:"RawResources"	, cnname: "RawResources"		, typeVal: RefType.MResource,	cls: "text-dsbd-green"},
